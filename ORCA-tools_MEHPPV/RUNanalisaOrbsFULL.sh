...
tools=/home/rramos/Dropbox/RREE-tools/ORCA-tools_MEHPPV


echo "WARN: Para o output do ORCA:: ao constroi a topologia automaticamente"
echo "WARN: ou seja precisa dar o arquivo -RINGS"
...
#	python $tools/Orbitais-AM1_GAU.py $name $1 $3 $4 > $name-ORBITAIS
	python $tools/Orbitais-ZD_ORCA.py $name $1 $3 $4 #> $name-ORBITAIS
